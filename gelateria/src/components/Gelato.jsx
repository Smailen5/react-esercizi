...
const Gelato = ({ id, nome, img, descrizione, prezzo, categoria }) => (
  <article
    key={id}
    className="group w-full flex items-center  gap-4 p-3 bg-sky-100 text-black shadow-lg rounded hover:bg-sky-400/[0.4] hover:scale-105 transition ease-linear lg:p-4"
  >
    <div className=" min-w-32 max-w-32 h-24 p-1 bg-white rounded-md shadow-md group-hover:scale-110 delay-300 transition-transform duration-500 md:group-hover:animate-bounce lg:min-w-44 lg:h-32">
      <img
        src={img}
        alt={nome}
