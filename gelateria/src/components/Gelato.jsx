...
const Gelato = ({ id, nome, img, descrizione, prezzo, categoria }) => (
  ...
  >
    <div className="min-w-32 h-24 p-1 bg-white rounded-md shadow-md group-hover:scale-110 delay-300 transition-transform duration-500 md:group-hover:animate-bounce lg:min-w-44 lg:h-32">
      <img
        src={img}
        alt={nome}
